    ...
    <form action="/cabang/simpan" method="POST" >
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-12 col-md-10">
                <input name="alamat" class="form-control" type="text" placeholder="Masukan Alamat">
            </div>
        </div>
        <div class="form-group row">
            <label class="col-sm-12 col-md-2 col-form-label">Nomor Telepon</label>
            <div class="col-sm-12 col-md-10">
                <input name="noHp" class="form-control" type="text" placeholder="Masukan Nomor Telepon">
            </div>
        </div>
